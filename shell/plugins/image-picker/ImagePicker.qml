...
Item {
  ...
  // Injected by roseshell-shell; defaults to the session ROSESHELL_PATH.
  property string roseshellPath: Quickshell.env("ROSESHELL_PATH")
  property string stateHome: Quickshell.env("HOME") + "/.local/state"
  property string imageDirs: Quickshell.env("ROSESHELL_IMAGE_SELECTOR_DIRS") || Quickshell.env("ROSESHELL_IMAGE_SELECTOR_DIR") || Quickshell.env("ROSESHELL_STOCK_BACKGROUNDS_DIR") || (stateHome + "/roseshell/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("ROSESHELL_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("ROSESHELL_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("ROSESHELL_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return roseshellPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by roseshell-shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "roseshell-image-selector"
