...
// Visual reference + live playground for roseshell-shell's common UI
// components. Summon with `roseshell dev ui-preview`, or directly via:
//   roseshell-shell shell summon roseshell.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `roseshell dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("roseshell.dev-gallery")
  ...
  FloatingWindow {
    id: window
    title: "Roseshell shell – dev gallery"
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("roseshell.dev-gallery")
    }
      ...
      PanelKeyCatcher {
        ...
        Column {
          ...
          Column {
            ...
            Text {
              text: "Roseshell shell · dev gallery"
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `roseshell font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["roseshell.clock", "roseshell.weather", "roseshell.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "roseshell.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "roseshell-menu", label: "Roseshell menu", description: "Launcher / system menu" },
