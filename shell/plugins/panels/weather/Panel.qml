...
Panel {
  id: root
  moduleName: "roseshell.weather"
  ipcTarget: "roseshell.weather"
  manageIpc: false
  ...
  // roseshell-weather-location). The query is the wttr.in path segment
  ...
  function persistLocation(name, latitude, longitude) {
    if (name && latitude !== null && longitude !== null)
      locationSaveProc.command = ["roseshell-weather-location", "--set", name, latitude + "," + longitude]
    else if (name)
      locationSaveProc.command = ["roseshell-weather-location", "--set", name]
    else
      locationSaveProc.command = ["roseshell-weather-location", "--clear"]
  ...
  // Mirrors roseshell-weather-icon's wttr.in code → nerd-font glyph mapping.
